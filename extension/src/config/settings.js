...
import { JUMP_REACH_DISTANCE, RUN_SPEED_MULTIPLIER } from '../core/constants.js';
...
export const DEFAULT_RUNTIME_CONFIG = Object.freeze({
    ...
    gravity: 2.4,
    maxFallSpeed: 24,
    jumpReachDistance: JUMP_REACH_DISTANCE,
});
...
export function readRuntimeConfig(settings) {
    return normalizeRuntimeConfig({
        ...
        jumpReachDistance: readInt(settings, 'jump-reach-distance', DEFAULT_RUNTIME_CONFIG.jumpReachDistance),
    });
}
...
export function normalizeRuntimeConfig(raw = {}) {
    ...
    const jumpReachDistance = clampNumber(raw.jumpReachDistance, 80, 900, DEFAULT_RUNTIME_CONFIG.jumpReachDistance);
